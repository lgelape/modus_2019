...
```{r}
banco <- read.table("https://raw.githubusercontent.com/lgelape/Curso_2018_ENAP/master/bancos/AtlasBrasil/AtlasBrasil_Consulta1.csv", sep = ";")
```
...
```{r}
banco <- read.table("https://raw.githubusercontent.com/lgelape/Curso_2018_ENAP/master/bancos/AtlasBrasil/AtlasBrasil_Consulta1.csv", sep = ";", encoding = "latin1", header = T, dec = ",")
```
